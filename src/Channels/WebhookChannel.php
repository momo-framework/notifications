...
/**
 * Delivers notifications implementing {@see RoutesToWebhook} to the recipient's
...
final class WebhookChannel implements NotificationChannelInterface
{
    ...
    {
        if (! $notification instanceof RoutesToWebhook) {
            return false;
        }
        ...
        $this->transport->send($notification->toWebhook($notifiable), $url);
